...
function AddSubtitlesModal(props) {
  //subtitle name
  ...
  const onSubmit = async () => {
    try {
      ...
      await axios.post(`${BaseUrl}subtitles`, Addname, {
  ...
  return (
    <>
      <CModal show={props.show} onClose={props.onClose} >
        <CModalHeader closeButton>Add subtitles</CModalHeader>
        <CModalBody>
          <CContainer fluid>
            <CRow>
              <CCol sm="12">
...
export default AddSubtitlesModal;