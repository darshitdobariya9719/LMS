...
const Instructor_Add = () => {
  ...
  const onSubmit = async (data) => {
    ...
    await axios.post(`${BaseUrl}users`, InstructorFormData, {
      headers: {
    ...
    window.location = "#/user/instructor";
          ...
          <CCardBody>
            <CForm action="" method="post" className="form" >
              ...
              <CFormGroup >
                ...
                <CSelect  id="select nf-password" name="status" innerRef={register({ required: true })}>
